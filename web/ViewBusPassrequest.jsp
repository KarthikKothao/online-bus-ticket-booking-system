...
<html>
    ...
    <body bgcolor="lightblue">
        ...
        <div id="abstract">
            ...
            <h2><center>View Customer Bus Pass Applications</center></h2>
            ...
            <%
             ...
             Statement st=con.createStatement();
                    ResultSet rs=st.executeQuery("select *from applybuspass ");
                    %>
                                ...
                                <td><%=rs.getString(1)%></td>
                                 <td><%=rs.getString(2)%></td>
                                  <td><%=rs.getString(3)%></td>
                                   ...
                                   <td><a href="Accept.jsp?username=<%=rs.getString(1)%>">Accept</a></td>
                                <td><a href="Reject.jsp?username=<%=rs.getString(1)%>">Reject</a></td>
