<%-- 
    ...
    Created on : Nov 13, 2022, 7:01:10 PM
    Author     : Lenovo
--%>
                ...
                try
                {
                   ...
                   // Connection con = DriverManager.getConnection("jdbc:mysql://mydb-instance.cuis34udkkqx.us-east-1.rds.amazonaws.com:3306/buspass?characterEncoding=utf8", "admin", "Swetha1234");
                    ...
                    <table border="2px" align="center">
                        <tr>
                      <th>Payment Id</th>  <th>User Name</th> <th>Address</th>
                      <th>  mobile Number</th> <th> From</th> <th> To </th> <th>card number</th> <th>Price</th> <th>Expiry Date</th> <th>CVV</th>                  
                        </tr>
                        <%while(rs.next())
                        {
                            %>
